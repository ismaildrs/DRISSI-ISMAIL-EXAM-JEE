...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager inMemoryUserDetailsManager() {
        return new InMemoryUserDetailsManager(
                User.builder().username("ismail").password(passwordEncoder().encode("wow")).roles("EMPOLYEE").build(),
                User.builder().username("user2").password(passwordEncoder().encode("wow")).roles("CLIENT").build(),
                User.builder().username("admin").password(passwordEncoder().encode("wow")).roles("EMPLOYEE", "ADMIN").build()
        );
    }
